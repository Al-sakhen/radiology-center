            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9 d-md-flex">
                        <h6 class="mr-3"><span class="mr-2"><i class="fa fa-mobile"></i></span> call us now! +1 305
                            708 2563</h6>
                        <h6 class="mr-3"><span class="mr-2"><i class="fa fa-envelope-o"></i></span>
                            medical@example.com</h6>
                ...
                <div class="col-lg-12">
                    <div class="department-slider owl-carousel">
                        <div class="single-slide">
                            <div class="slide-img">
                                <img src="{{ asset('EndUserAssets/assets/images/department1.jpg') }}" alt=""
                                    class="img-fluid">
                        ...
                        <div class="single-slide">
                            <div class="slide-img">
                                <img src="{{ asset('EndUserAssets/assets/images/department2.jpg') }}" alt=""
                                    class="img-fluid">
                                <div class="hover-state">
                        ...
                        <div class="single-slide">
                            <div class="slide-img">
                                <img src="{{ asset('EndUserAssets/assets/images/department3.jpg') }}" alt=""
                                    class="img-fluid">
                                <div class="hover-state">
                                    <a href="departments.html"><i class="fa fa-stethoscope"></i></a>
                                </div>
